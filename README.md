...
question_1_sdtm/            # SDTM DS Domain Creation
  01_create_ds_domain.csv     # Main script
...
question_3_tlg/                     # TLG - Adverse Events Reporting
  01_create_ae_summary_table.log      # Summary table of treatment-emergent adverse events (TEAEs) execution log
  01_create_ae_summary_table.R        # Summary table of treatment-emergent adverse events (TEAEs) script
  02_create_ae_summary_table.log      # Visualizations of AEs execution log
  02_create_ae_summary_table.R        # Visualizations of AEs script
